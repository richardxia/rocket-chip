...
class BaseSubsystemBusAttachment(name: String) extends Location[TLBusWrapper](name)
case object SBUS extends BaseSubsystemBusAttachment("subsystem_sbus")
case object PBUS extends BaseSubsystemBusAttachment("subsystem_pbus")
case object FBUS extends BaseSubsystemBusAttachment("subsystem_fbus")
case object MBUS extends BaseSubsystemBusAttachment("subsystem_mbus")
case object CBUS extends BaseSubsystemBusAttachment("subsystem_cbus")
case object L2   extends BaseSubsystemBusAttachment("subsystem_l2")
